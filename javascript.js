let pelis = [
    ...
    { titulo: "Expediente Warren 2", sala:4,horario: "20:00h", precio: 12, sinopsis: "Ed y Lorraine Warren, renombrados demonólogos e investigadores de lo paranormal, se enfrentan de nuevo a las fuerzas infernales. En esta ocasión, viajan hasta el norte de Londres para tratar de ayudar a una madre y sus cuatro hijos, quienes habitan en una casa plagada de espíritus malignos.", edad: "+18", imagen: "imagenes/Expediente Warren 2.jpg" },
    { titulo: "Torrente 4", sala:4,horario: "13:00h", precio: 10, sinopsis: "Cuarta entrega de las aventuras del casposo policía José Luis Torrente. En esta ocasión encontramos a Torrente en una situación delicada. Tras varios intentos fallidos de llevar una vida digna (como si eso fuese posible), decide aceptar un peligroso encargo que le hace un viejo conocido.", edad: "+18", imagen: "imagenes/Torrente 4.jpg" },
    { titulo: "La Matanza de Texas", sala:4,horario: "23:30h", precio: 8, sinopsis: "Un grupo de jóvenes se pierde en medio de las desérticas carreteras de Texas, y termina encontrándose con una familia de matarifes que los persigue con una sierra mecánica, descuartizándolos uno por uno.", edad: "+18", imagen: "imagenes/La Matanza de Texas.jpg" },
    { titulo: "Danny the Dog", sala:4,horario: "16:15h", precio: 15, sinopsis: "El ex agente Robert McCall se encuentra en el sur de Italia y pronto descubre que sus nuevos amigos están bajo el control de los jefes del crimen local. Cuando los acontecimientos se vuelven mortales, McCall se convierte en su protector.", edad: "+18", imagen: "imagenes/The equalizer 3.jpg" },
